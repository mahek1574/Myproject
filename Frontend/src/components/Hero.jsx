    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 lg:px-10">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 md:gap-10 lg:gap-12 items-center">
          ...
          {/* RIGHT ILLUSTRATION - EXTENDED 420PX SIZE FROM 830PX UP TO 960PX */}
          <div className="w-full lg:col-span-5 relative flex justify-center items-center mt-12 lg:mt-0">
            {/* 
              - Default size is compact for smaller mobile phones.
              - max-[390px] preserves your custom iPhone configuration.
              - min-[830px]:max-[960px] applies the exact large 420px size across the entire range from 830px up to 960px.
            */}
